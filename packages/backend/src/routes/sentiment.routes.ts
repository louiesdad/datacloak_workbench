...
router.post('/analyze/sample', asyncHandler(sentimentController.analyzeSample.bind(sentimentController)));
router.get('/analyze/progress/:jobId', asyncHandler(sentimentController.getAnalysisProgress.bind(sentimentController)));
