...
exports.SecurityIntegrationUtils = exports.BackendSecurityClient = void 0;
exports.createSecurityClient = createSecurityClient;
class BackendSecurityClient {
    constructor(config = {}) {
        this.eventQueue = [];
    ...
    async updateComplianceStatus(datasetId, status) {
    ...
    async getAuditHistory(limit = 50) {
        ...
        return response.data.map((item) => this.transformAuditResponse(item));
    }
    async bulkAuditDatasets(datasetIds) {
    ...
    async scheduleAudit(datasetId, scheduleConfig) {
    ...
    establishSecurityStream(onEvent) {
...
exports.BackendSecurityClient = BackendSecurityClient;
// Factory function for easy instantiation
function createSecurityClient(config) {
    return new BackendSecurityClient(config);
}
// Utility functions for integration
class SecurityIntegrationUtils {
    static async validateBackendCompatibility(client) {
        const issues = [];
    ...
    static createMockResponse(type) {
        switch (type) {
            case 'audit':
                return {
                    timestamp: new Date(),
...
exports.SecurityIntegrationUtils = SecurityIntegrationUtils;
//# sourceMappingURL=backend-security-client.js.map